...
import 'package:project/WorkOut.dart';
              ...
              children: [
                ...
                Align(
                    ...
                    child: Padding(
                      ...
                      child: Text("Tips: Stay safe, prevent injury." , style: TextStyle(fontSize: 18 ,fontWeight: FontWeight.bold),),
                    ))
  ...
  MyTimer(context) async{
    Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      if(countdown == 0){
        timer.cancel();
        timer.cancel();
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>WorkOut(ListOfYoga: AllYoga, yogaindex: 0)));
      }
      notifyListeners();
